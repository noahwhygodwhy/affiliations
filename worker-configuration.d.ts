// remember to put this back after generating, but you need to run
// `npx wrangler types` to generate this

/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7420f0e33b106aeb8af3b92b5cb8a914)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TestSecret">> {}
}
